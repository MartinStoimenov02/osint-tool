// кон тролерът, който управлява търсенето на имейли по домейн
...
const searchByDomain = async (req, res) => {
    try {
        ...
        // Връща се целия обект, за да може фронтендът да си визуализира и всички детайли на служителите
